...
<!--MENU 2-->
<nav class="navbar navbar-expand-lg navbar-infiwhite py-3 fixed-top">
    <a class="navbar-brand" href="?"><img class="img-responsive" src="img/log-ogihd.png" alt="Logo Original Nest" width="100px"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item active">
            ...
            <li class="nav-item">
                <a class="nav-link" href="?page=why-choose-us">Why choose us?</a>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="#">Bird nest gallery</a>
